...
public class Date {
	...
	public Date(String strDate) {
		/*
		 * Parses a string parameter in form MM/DD/YYYY into integer values.
		 * Instantiates the class with these parsed values.
		 */
		String[] parsedDates = strDate.split("/", -1);

		int monthInt = Integer.parseInt(parsedDates[0]);
		int dayInt = Integer.parseInt(parsedDates[1]);
		int yearInt = Integer.parseInt(parsedDates[2]);
